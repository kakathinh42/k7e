...
> **k7e** is a numeronym for **knowledge** — the "k", the seven letters
> between (n·o·w·l·e·d·g), and the "e". Same naming lineage as
> [n8n](https://n8n.io) (*nodemation*) and k8s (*kubernetes*).
