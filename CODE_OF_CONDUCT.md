...
reported to the maintainers at **kakathinh42@gmail.com** (or via the private
channels in `SECURITY.md` if sensitive). All complaints will be reviewed and
investigated promptly and fairly.

See the [Contributor Covenant](https://www.contributor-covenant.org/version/2/1/code_of_conduct/)
enforcement guidelines for more detail.
